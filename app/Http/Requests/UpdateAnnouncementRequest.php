        ...
        return [
            ...
            'target_id' => [
                ...
                function ($attribute, $value, $fail) {
                    // Get target_type from request input, fallback to DB if not present in input but route is present
                    $targetType = $this->input('target_type');
                    if (is_null($targetType) && $this->route('announcement')) {
                        $targetType = DB::table('announcements')
